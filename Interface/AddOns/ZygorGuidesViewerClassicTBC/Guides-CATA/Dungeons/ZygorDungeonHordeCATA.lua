...
Jump down here |goto 43.42,72.89 < 5 |walk
Follow the path |goto 42.40,75.87 < 10 |walk
Follow the path |goto 41.79,78.54 < 10 |walk
Jump down here |goto 39.64,78.12 < 10 |walk
...
Swim underwater into the cave |goto 13.28,13.23 < 10 |walk
Follow the path |goto 13.90,10.92 < 10 |walk
Follow the path |goto 13.74,9.38 < 10 |walk
Follow the path |goto 14.37,9.20 < 10 |walk
Follow the path |goto 16.50,11.61 < 10 |walk
...
Ride the elevator down |goto 23.41,39.21 < 10 |walk
Follow the path |goto 21.98,36.73 < 10 |walk
Follow the path |goto 19.93,36.02 < 10 |walk
...
Enter the Portal |goto 84.84,30.51 < 7 |walk
...
step
Enter the building |goto Tirisfal Glades/0 82.65,32.88 < 7 |walk
Enter the Portal |goto 85.33,32.27 < 7 |walk
...
step
Enter the building |goto Tirisfal Glades/0 82.65,32.88 < 7 |walk
click Armory Door |goto 85.41,31.59 < 7 |walk
...
Enter the Portal |goto 85.67,31.76 < 7 |walk
...
step
Enter the building |goto Tirisfal Glades/0 82.65,32.88 < 7 |walk
click Cathedral Door |goto 85.21,30.86 < 7 |walk
|tip You will need The Scarlet Key from the chest behind Arcanist Doan in the Library to open this.
|tip A rogue with 175 Lockpicking skill can pick it and a Truesilver Key opens it too.
|tip Engineers can also blast the door open.
Enter the Portal |goto 85.32,30.48 < 7 |walk
...
Jump down here |goto 28.06,64.21 < 7 |c |walk
step
Jump down here |goto 27.84,62.83 < 10
Follow the path |goto 29.32,61.24 < 7 |walk
Follow the path |goto 29.67,58.58 < 7 |walk
...
step
Jump down here |goto 27.84,62.83 < 10
Follow the path |goto 29.39,64.03 < 7 |walk
Run up the stairs |goto 31.30,64.06 < 10 |walk
Follow the path |goto 34.29,65.57 < 10 |walk
Follow the path |goto 35.14,62.71 < 7 |walk
...
step
Jump down here |goto 27.84,62.83 < 10
Jump down here |goto 29.81,60.75 < 7 |walk
...
click Portal to Inner Maraudon |goto 29.24,61.18
...
Enter the building and swim under the water |goto 70.54,49.78 < 7 |walk
Run down the stairs |goto 72.69,42.22 < 7 |walk
Follow the path |goto 75.69,45.78 < 7 |walk
Follow the path |goto 78.62,47.47 < 7 |walk
Follow the path |goto 80.22,49.62 < 7 |walk
Follow the path |goto 81.33,42.38 < 7 |walk
Run down the stairs |goto 78.86,40.74 < 7 |walk
Run down the ramp |goto 76.85,38.82 < 7 |walk
...
Enter the building |goto 35.91,100.22 < 7 |c
step
Continue down and run down the chain |goto 34.86,99.20 < 5 |walk
Enter the building |goto 32.55,94.94 < 5 |walk
Follow the path |goto 26.88,83.87 < 30 |walk
...
Follow the path |goto 59.52,39.51 < 15 |only if walking
Continue following the path |goto 61.72,38.78 < 15 |only if walking
Continue following the path |goto 61.15,34.87 < 7 |only if walking
Continue following the path |goto 64.85,30.18 < 7 |only if walking
...
Continue following the path |goto 61.72,38.78 < 15 |only if walking
Continue following the path |goto 61.15,34.87 < 7 |only if walking
click Door |goto 62.49,24.89 < 5 |walk
...
Continue following the path |goto 61.72,38.78 < 15 |only if walking
Continue following the path |goto 61.15,34.87 < 7 |only if walking
click Door |goto 60.32,30.16 < 10 |walk
|tip You need a Crescent Key to unlock this door.
|tip This drops from Pusillin in the "Dire Maul - East" dungeon.
...
Jump down here |goto 37.79,92.44 < 5 |walk
Jump to the balcony |goto 39.72,95.58 < 5 |walk
...
Jump down into the water |goto 43.97,35.37 < 20 |walk
...
step
Follow the path |goto 14.37,9.20 < 10 |walk
Continue following the path |goto 16.50,11.61 < 10 |walk
...
talk Varimathras##2425
turnin An Unholy Alliance##6522 |goto 56.23,92.18 |only if haveq(14352) or completedq(14352)
turnin An Unholy Alliance##6522 |goto 56.23,92.18 |only if haveq(6522) or completedq(6522)
step
talk Varimathras##2425
'|accept An Unholy Alliance##6521
'|accept An Unholy Alliance##14353
Accept An Unholy Alliance |complete haveq(6521,14353) or completedq(6521,14353) |goto 56.23,92.18
step
...
collect Ambassador Malcin's Head##17009 |q 6521/1 |goto 48.52,95.62 |only if haveq(6521) or completedq(6521)
collect Ambassador Malcin's Head##17009 |q 14353/1 |goto 48.52,95.62 |only if haveq(14353) or completedq(14353)
You can also find him around: |notinsticky
[48.09,92.47]
[47.78,90.71]
[46.30,90.26]
...
Follow the path |goto 51.86,64.67 < 10 |only if walking
talk Varimathras##2425
turnin An Unholy Alliance##6521 |goto 56.23,92.18 |only if haveq(6521) or completedq(6521)
turnin An Unholy Alliance##14353 |goto 56.23,92.18 |only if haveq(14353) or completedq(14353)
]])
...
Enter the cave |goto 54.50,57.78 < 7 |walk
...
step
Enter the cave |goto 28.71,56.20 < 5 |only if walking
use the Amulet of Spirits##17757
|tip Use it on the Spirit of Gelk.
|tip He walks around this area.
kill Gelk##13741
collect Gem of the Second Khan##17762 |goto 38.47,57.29 |q 7067
step
...
step
Jump down here |goto 38.53,57.60 < 5 |only if walking
use the Amulet of Spirits##17757
...
Continue following the path |goto 38.44,58.13 < 7 |only if walking
...
Jump into the lava |complete isdead |goto 34.62,95.45 |q 3801 |future
...
Jump into the lava |goto 34.62,95.45 < 7 |only if walking |zombiewalk
Run up the chain |goto 33.53,96.61 < 5 |only if walking |zombiewalk
Enter the building |goto 36.06,98.76 < 5 |only if walking |zombiewalk
talk Franclorn Forgewright##8888
|tip You must be dead to talk to him.
accept Dark Iron Legacy##3801 |goto 35.50,100.38 |zombiewalk
step
talk Franclorn Forgewright##8888
|tip You must be dead to talk to him.
...
collect Fourth Mosh'aru Tablet##12412 |q 5065/2 |goto 67.25,11.39
step
click Third Mosh'aru Tablet##175487
|tip At the top of the temple.
collect Third Mosh'aru Tablet##12411 |q 5065/1 |goto 66.94,8.84
step
talk Prospector Ironboot##10460
...
|tip He walks around this area.
collect Blackhand's Command##18987 |goto 49.12,64.10 |complete itemcount(18987) == 1 or haveq(7761) or completedq(7761)
step
...
Plant #20# Kil'sorrow Banners |q 9931/1 |goto 46.84,23.00
step
...
step
kill 15 Agitated Orc Spirit##18043 |q 10082/1 |goto 26.51,60.10
step
talk Mother Kashur##18687
...
Gain the Blood Elf Disguise |havebuff Blood Elf Illusion##37096 |goto 46.43,70.64 |q 10577
step
...
collect Scintillating Fragment##35648 |goto 33.91,27.72 |q 11941 |future
step
...
accept Springing the Trap##11969 |goto 33.31,34.53
step
use Raelorasz' Spark##44950
|tip Use it next to the Signal Fire.
Watch the dialogue
Lure Malygos |q 11969/1 |goto 25.40,21.77
step
Watch the dialogue
Fly with Keristrasa |goto 34.19,25.55 < 20 |c |q 11969
step
talk Raelorasz##26117
turnin Springing the Trap##11969 |goto 33.31,34.53
accept Prisoner of War##11973 |goto 33.31,34.53
step
talk Raelorasz##26117
...
accept Rampage##12721 |goto 60.26,57.74
step
click Akali Chain Anchor |goto 78.54,24.90
click Akali Chain Anchor |goto 79.08,25.56
click Akali Chain Anchor |goto 79.10,24.21
click Akali Chain Anchor |goto 78.16,24.17
|tip Click the four anchors to release Akali.
Free Akali from His Chains |q 12721/1
step
talk Witch Doctor Khufu##28479
turnin Rampage##12721 |goto 59.50,58.04
accept The Gods Have Spoken##12729 |goto 59.50,58.04
step
kill Altar Warden##28784+
collect Gusty Essence of the Warden##39541 |q 12729/2 |goto 72.54,58.64
You can find more around [70.40,61.09]
step
kill Guardian of Zim'Rhuk##28597+
collect Unblemished Heart of the Guardian##39540 |q 12729/1 |goto 60.02,45.38
step
talk Har'koa##28401
turnin The Gods Have Spoken##12729 |goto 60.19,57.72
accept Convocation at Zol'Heb##12730 |goto 60.19,57.72
step
use Prophet of Akali Convocation##39566
kill Prophet of Akali##29028
|tip You may need help with this.
Watch the dialogue
Slay the Prophet of Akali |q 12730/1 |goto 77.60,36.64
step
talk Har'koa##28401
turnin Convocation at Zol'Heb##12730 |goto 60.19,57.72
accept Unfinished Business##13097 |goto 60.19,57.72
step
...
Ride an Argent Battleworg |invehicle |goto 44.46,33.67
step
...
Click Here to Continue |confirm |goto 50.96,52.36
...
step
Enter Onyxia's Lair |goto 52.13,75.78
...
step
_Phase 1:_
kill Gormok the Impaler##34796 |goto 42.61,52.35
...
Click Here to Advance to Phase 3 |confirm |goto 42.61,52.35
step
_Phase 3:_
kill Icehowl##34797
...
Click Here to Continue |confirm |goto 42.61,52.35
step
talk Barrett Ramsey##34816
Tell him _"What new challenge await us?"_
|tip This will start the next boss fight.
|tip Make sure you are ready.
Click Here to Continue |confirm |goto 64.26,53.65
step
kill Lord Jaraxxus##34780 |goto 50.99,52.43
...
Click Here to Continue |confirm |goto 50.99,52.43
step
talk Barrett Ramsey##34816
...
turnin Inside the Frozen Citadel##24510 |goto 64.00,91.20
accept Echoes of Tortured Souls##24511 |goto 64.00,91.20
step
...
|tip Random players are feared during Soulstorm.
|tip All players must be within 10 yards of him or suffer damage and reduced speed during Soulstorm.
Defeat Bronjahm |goto The Forge of Souls/1 43.3,49.8
Click Here to Continue |q 24511/1 |goto 43.35,49.88
step
kill Spiteful Apparition##36551
|tip Be wary of these ghostly skulls. They are invisible.
map The Forge of Souls/0
...
|tip If targeted by "Unleashed Souls" run away from during their duration.
|tip Avoid standing in front of her to avoid damage from "Wailing Souls".
Click Here to Continue |q 24511/2 |goto 43.67,12.36
step
talk Lady Sylvanas Windrunner##37596
turnin Echoes of Tortured Souls##24511 |goto 44.00,13.10
accept The Pit of Saron##24682 |goto 44.00,13.10
]])
...
Click Here to Continue |confirm |goto 66.40,55.50
step
kill Ick##36476
kill Krick##36477
...
Click Here to Continue |confirm |goto 47.40,41.50
step
...
Click Here to Continue |confirm |goto 44.50,23.10
]])
...
turnin The Pit of Saron##24682 |goto 40.80,79.70
accept The Path to the Citadel##24507 |goto 40.80,79.70
...
|tip Everyone but the tank should stay behind him to avoid taking damage from "Chilling Wave".
|tip He casts "Deep Freeze" on random players, slowing movement speed, then freezes the player after 14 seconds dealing frost damage.
Defeat Forgemaster Garfrost |q 24507/2 |goto 66.40,55.50
step
talk Martin Victus##37591
turnin The Path to the Citadel##24507 |goto 65.50,54.90
accept Deliverance from the Pit##24712 |goto 65.50,54.90
step
map Pit of Saron/0
path follow smart; loop off; ants curved; dist 15
...
|tip After 3 seconds, they will detonate damaging anyone within 6 yards of them.
|tip Krick hurls "Toxic Waste" at random players, leaving behind puddles that deal nature damage to anyone within 4 yards of the impact.
Click Here to Continue |confirm |goto 47.40,41.50 |q 24712
step
map Pit of Saron/0
path follow smart; loop off; ants curved; dist 15
...
|tip "Mark of Rimefang" will attack the target from the air.
|tip Run away from group members and keep moving.
Defeat Scourgelord Tyrannus |q 24712/1 |goto 44.50,23.10
step
talk Lady Sylvanas Windrunner##37596
|tip you will have to wait for her to show up.
turnin Deliverance from the Pit##24712 |goto 39.70,16.10
accept Frostmourne##24713 |goto 39.70,16.10
]])
...
Click Here to Continue |confirm |goto 42.81,62.65
step
kill Falric##38112
...
Click Here to Continue |confirm |goto 34.94,74.95
step
kill Marwyn##38113
...
Click Here to Continue |confirm |goto 13.54,21.62
step
_Kill Priority_:
...
step
talk Lady Sylvanas Windrunner##37596
turnin Frostmourne##24713 |goto 44.52,75.51
step
talk Lady Sylvanas Windrunner##37596
Ask her _"Can you remove the sword?"_
|tip Watch the dialogue that follows.
|tip When your group is ready, choose "I think I hear Arthas coming."
Click Here to Continue |confirm |goto 44.52,75.51 |q 24802 |future
step
Incoming Waves of Enemies
|tip You will need to survive 5 waves of enemies to reach the first boss.
|tip LoS the trash and wait for them to come to you.
...
|tip Casters avoid standing near these as they interrupt spellcasting.
At wave 5, you will face Falric
Click Here to Continue |confirm |goto 42.81,62.65 |q 24802 |future
step
kill Falric##38112
|tip "Quivering Strike" deals damage and reduces dodge chance by 20% for 5 seconds and should be dispelled.
|tip Dispel "Impending Despair" as it appears, or the target will be stunned for 6 seconds.
...
|tip Casters avoid standing near these as they interrupt spellcasting.
At wave 10, you will face Marwyn
Click Here to Continue |confirm |goto 34.94,74.95 |q 24802 |future
step
kill Marwyn##38113
|tip "Obliterate" deals heavy damage to Marwyn's current target.
|tip Move out of "Well of Corruption" which increases shadow damage taken by 75% and stacks 4 times.
...
step
talk Lady Sylvanas Windrunner##37596
Find Lady Sylvanas Windrunner |q 24802/1 |goto 13.54,21.62
step
talk Lady Sylvanas Windrunner##37596
Tell her: "_We're ready! Let's go!_"
Click Here to Continue |confirm |goto 13.54,21.62
...
step
talk Lady Sylvanas Windrunner##37596
turnin Wrath of the Lich King##24802 |goto 75.82,76.23
]])
...
Click Here to Continue |confirm |goto 38.98,59.62
step
...
Click Here to Continue |confirm |goto 38.93,86.53
step
kill Lady Deathwhisper##36855
_PHASE 2_
_TANK_
...
step
label "Kill_Balharus"
kill Baltharus the Warborn##39751 |goto 68.23,54.50
...
step
label "Kill_Saviana"
kill Saviana Ragefire##39747 |goto 35.23,54.79
...
kill General Zarithrian##39746 |goto 49.82,75.90
...
step
label "Kill_Halion"
kill Halion##39863 |goto 48.86,53.62
_Phase 1_
...
Click Here to Continue |confirm
step
kill Corla, Herald of Twilight##39679 |goto 27.4,16.6 |only if not haveq(28737)
kill Corla, Herald of Twilight##39679 |goto 27.4,16.6 |q 28737/1 |or |only if haveq(28737)
_EVERYONE:_ |grouprole EVERYONE
...
Click Here to Continue |confirm
step
kill Karsh Steelbender##39698 |only if not haveq(28738) |goto 45.6,65.6
kill Karsh Steelbender##39698 |q 28738/1 |only if haveq(28738) |goto 45.6,65.6 |or
_EVERYONE:_ |grouprole EVERYONE
...
step
Watch for the Elemental Patrol |goto 69.6,72.2
Click Here to Continue |confirm
step
_Click the Quest Complete Box:_
accept Ascendant Lord Obsidius##28741 |goto 70.0,63.4
step
kill Ascendant Lord Obsidius##39705 |goto 68.8,56.0 |only if not haveq(28741)
kill Ascendant Lord Obsidius##39705 |goto 68.8,56.0 |q 28741/1 |only if haveq(28741)
_EVERYONE:_ |grouprole EVERYONE
...
path	49.9,49.7	Throne of the Tides/1 50.1,84.5
Follow the path |goto Throne of the Tides/1 50.1,84.5 < 12
