...
Take a Flight to the Dead Scar |invehicle |goto 48.51,25.22 |q 11533
...
|only if haveq(11533) or completedq(11533)
step
Return to Sun's Reach |outvehicle |goto 48.39,25.25 |q 11533
|only if haveq(11533) or completedq(11533)
step
talk Ayren Cloudbreaker##25059
Tell him _"I need to intercept the Dawnblade reinforcements."_
Take a Flight to the Dawnblade Fleet |invehicle |goto 48.51,25.22 |q 11543
...
Gain the "Bash'ir Phasing Device" Buff |havebuff Bash'ir Phasing Device##44856 |goto 51.36,18.88 |q 11514
|only if haveq(11514) or completedq(11514)
step
...
Take a Drake Flight |invehicle |goto 57.91,54.17
|only if not knowspell(54197)
step
Fly to the Top of the Temple |outvehicle |goto 59.73,53.13 |q 12419
|only if not knowspell(54197)
step
talk Krasus##27990
...
Take a Drake Flight |invehicle |goto 59.53,53.30 |q 12435
|only if not knowspell(54197)
step
Fly to the Middle of the Temple |outvehicle |goto 59.20,54.33 |q 12435
|only if not knowspell(54197)
step
...
Subdue the Nexus Drake |havebuff Drake Hatchling Subdued##46691 |goto 24.73,26.36 |q 11919
step
...
|tip Use it on a Nexus Drake Hatchling.
|tip They are flying above you in the sky.
Subdue the Nether Drake |havebuff Drake Hatchling Subdued##46691 |goto 24.73,26.36 |q 11940
step
...
accept Whatever it Takes!##13108 |goto 65.44,60.16 |noautoaccept
...
step
talk Lorekeeper Randvir##30252
turnin Forging Hodir's Spear##13001 |goto 64.84,59.05 |next "Begin_Daily_Quests"
...
Gain the "Dark Discernment" Buff |complete hasbuff(60311) or readyq(13322) or completedq(13322) |goto 54.32,29.25
|only if haveq(13322) or completedq(13322)
step
Kill enemies around this area
collect 10 Tainted Essence##44301 |goto 54.32,29.25 |q 13322 |or
...
collect Writhing Mass##44304 |goto 54.32,29.25 |q 13322
|only if haveq(13322) or completedq(13322)
step
...
collect 5 Dark Matter##44434 |goto 54.32,29.25 |q 13344
|only if haveq(13344) or completedq(13344)
step
click Summoning Stone
Summon the Dark Messenger |q 13344/1 |goto 53.77,33.60
|only if haveq(13344) or completedq(13344)
step
use the Writhing Mass##44304
|tip Stand next to the large cauldron.
Banish the Writhing Mass |q 13322/1 |goto 49.11,34.15
|only if haveq(13322) or completedq(13322)
step
use Dart Gun##44222
|tip Use it on Orgrim's Hammer Scouts flying around in the air.
collect 6 Orgrim's Hammer Dispatch##44220 |q 13333/1 |goto 43.13,53.46
...
step
Click Geargrinder's Jumpbot to get in the robot |invehicle |q 13280 |goto 56.99,62.60
|only if haveq(13280) or completedq(13280)
step
Plant the Alliance Battle Standard |q 13280/1 |goto 54.88,60.09
...
|only if haveq(13280) or completedq(13280)
step
Exit Geargrinder's Jumpbot |outvehicle |goto 57.00,62.57 |script VehicleExit() |q 13280
|tip Use it to return to the ground first or fly down.
|only if haveq(13280) or completedq(13280)
step
talk Frazzle Geargrinder##31776
turnin King of the Mountain##13280 |goto 57.00,62.57
|only if haveq(13280) or completedq(13280)
step
...
Drag and Drop #3# Dark Subjugators |q 13323/1 |goto 53.76,46.31
|only if haveq(13323) or completedq(13323)
step
talk Kibli Killohertz##32444
accept Putting the Hertz: The Valley of Lost Hope##13382 |goto 53.96,42.93
accept Static Shock Troops: the Bombardment##13404 |goto 53.96,42.93
|only if completedq(13381)
step
talk Karen No##31648
Tell her _"Give me a bomber!"_
Board a Bomber |invehicle |goto 53.96,43.11 |q 13382
|only if haveq(13382) or completedq(13382)
step
talk Karen No##31648
Tell her _"Give me a bomber!"_
Board a Bomber |invehicle |goto 53.96,43.11 |q 13404
...
step
talk Kibli Killohertz##32444
turnin Putting the Hertz: The Valley of Lost Hope##13382 |goto 53.96,42.93
turnin Static Shock Troops: the Bombardment##13404 |goto 53.96,42.93
...
Control the Skybreaker Suppression Turret |invehicle |goto 62.56,50.64 |q 13309
...
accept Assault by Ground##13284 |goto 62.51,51.14
|only if completedq(13341)
step
map Icecrown/0
...
step
Enter the cave |goto 56.77,57.45 < 30 |walk
talk Saronite Mine Slave##31397
|tip Inside the cave.
Tell them _"Go on, you're free. Get out of here!"_
Rescue #10# Saronite Mine Slaves |q 13300/1 |goto 55.26,58.81
|only if haveq(13300) or completedq(13300)
step
Leave the Cave |goto 56.77,57.45 < 30 |c |walk |q 13300
|only if haveq(13300) or completedq(13300)
step
label "Slay_Ymirheim_Vrykul"
Kill Ymirjar enemies around this area
Slay #20# Ymirheim Vrykul |q 13336/1 |goto 58.56,57.18
...
collect Flesh Giant Spine##44009 |goto 63.44,56.59 |q 13295
You can find more around:
[64.53,58.88]
[66.46,58.56]
[65.75,62.99]
...
step
Enter the building |goto 63.44,62.10 < 10 |walk
use the Flesh Giant Spine##44009
|tip Use it next to the cauldron.
collect Pustulant Spinal Fluid##44010 |goto 62.18,63.36 |q 13295
|only if haveq(13295) or completedq(13295)
step
...
Neutralize the Plague Cauldron |q 13295/1 |goto 62.18,63.36
|only if haveq(13295) or completedq(13295)
step
Leave the building |goto 63.44,62.10 < 15 |c |walk |q 13295
|only if haveq(13295) or completedq(13295)
...
collect 3 Abandoned Armor##43616 |q 13292 |goto 69.64,64.98
...
collect 3 Abandoned Helm##43610 |q 13292 |goto 69.64,64.98
|only if haveq(13292) or completedq(13292)
step
...
collect 3 Pile of Bones##43609 |q 13292 |goto 69.64,64.98
|only if haveq(13292) or completedq(13292)
step
use Smuggled Solution##44048
|tip Use it 3 times.
Destroy #3# Frostbrood Skytalons |q 13292/1 |goto 69.64,64.98
|only if haveq(13292) or completedq(13292)
...
Explode #15# Icy Ghouls |q 13289/1 |goto 68.05,60.88
...
Explode #15# Vicious Geists |q 13289/2 |goto 68.05,60.88
...
|tip You can only collect one at a time. |notinsticky
use the Abomination Reanimation Kit##43968 |notinsticky
Explode #15# Risen Alliance Soldiers |q 13289/3 |goto 68.05,60.88
|tip Send your Hulking Abomination into groups of undead enemies nearby to the north of this location. |notinsticky
|tip Use the "Burst at the Seams" ability on your pet action bar when it is near groups of enemies. |notinsticky
|only if haveq(13289) or completedq(13289)
step
...
accept Shoot 'Em Up##13069 |goto 43.64,25.13
step
talk Vile##30216
|tip He walks around this area.
accept Vile Like Fire!##13071 |goto 43.04,25.43
step
clicknpc Jotunheim Rapid-Fire Harpoon##30337
Board a Jotunheim Rapid-Fire Harpoon |invehicle |goto 32.94,23.93 |q 13069
step
...
Plant #15# Ebon Blade Banners Near Vrykul Corpses |q 12995/1 |goto 32.51,27.91
step
clicknpc Njorndar Proto-Drake##30272
Ride a Njorndar Proto-Drake |invehicle |goto 27.22,39.02 |q 13071
step
Burn #8# Vrykul Buildings |q 13071/1 |goto 30.75,39.08
|tip Use the abilty on your vehicle bar.
You can find more around:
[31.43,42.62]
[29.16,46.41]
...
step
talk The Leaper##30074
turnin Shoot 'Em Up##13069 |goto 43.64,25.13
step
talk Vile##30216
|tip He walks around this area.
turnin Vile Like Fire!##13071 |goto 43.04,25.43
step
...
|tip He walks around this area.
accept Intelligence Gathering##12838 |goto 19.77,48.09
step
talk Uzo Deathcaller##29405
accept No Fly Zone##12815 |goto 19.64,47.80
step
Kill Onslaught enemies around this area
use the Darkmender's Tincture##40587
|tip Use it on their corpse.
Transform #10# Scarlet Onslaught Corpses |q 12813/1 |goto 9.40,42.90
...
collect 5 Onslaught Intel Documents##40640 |q 12838/1 |goto 9.40,42.90
...
step
kill 10 Onslaught Gryphon Rider |q 12815/1 |goto 9.44,43.27
...
talk Aurochs Grimbane##29456
|tip He walks around this area.
turnin Intelligence Gathering##12838 |goto 19.77,48.09
|only if haveq(12838) or completedq(12838)
step
talk Uzo Deathcaller##29405
...
accept A Worthy Weapon##13600 |goto 76.60,19.12 |only if questpossible |or
accept The Edge Of Winter##13616 |goto 76.60,19.12 |only if questpossible |or
Accept the Marshal's Daily Quest |complete false |or |goto 76.60,19.12 |only if not completedq(13603,13600,13616,13699)
Accept the Marshal's Daily Quest |complete true |or |goto 76.60,19.12 |only if completedq(13603,13600,13616,13699)
|tip You will only be able to accept one quest each day.
step
talk Sir Marcus Barlowe##33222
...
accept You've Really Done It This Time, Kul##14096 or completedq(14074,14152,14080,14077,14096) |goto 76.26,19.63 |only if questpossible |or 2
Accept Narasi's Daily Quest |complete false |goto 76.26,19.63 |or
...
Accept Savinia's Daily Quest |complete false or completedq(14092,14141,14145) |goto 76.21,19.56 |or
|tip You will only be able to accept one quest each day.
step
talk Stabled Argent Hippogryph##35117
Choose _Mount the Hippogryph and prepare for battle!_
...
Mount the Stabled Exodar Elekk |invehicle |q 13793 |goto 71.68,22.38 |only if Draenei
Mount the Stabled Ironforge Ram |invehicle |q 13793 |goto 71.80,22.50 |only if Dwarf
Mount the Stabled Stormwind Steed |invehicle |q 13793 |goto 71.56,22.42 |only if Human
Mount the Stabled Darnassian Nightsaber |invehicle |q 13793 |goto 71.62,22.49 |only if NightElf
Mount the Stabled Gnomeregan Mechanostrider |invehicle |q 13793 |goto 71.93,22.50 |only if Gnome
|only if haveq(13793) or completedq(13793)
step
...
clicknpc Stabled Darnassian Nightsaber##33794 |only if NightElf
clicknpc Stabled Gnomeregan Mechanostrider##33793 |only if Gnome
Mount the Stabled Exodar Elekk |invehicle |q 13790 |goto 71.68,22.38 |only if Draenei
Mount the Stabled Ironforge Ram |invehicle |q 13790 |goto 71.80,22.50 |only if Dwarf
Mount the Stabled Stormwind Steed |invehicle |q 13790 |goto 71.56,22.42 |only if Human
Mount the Stabled Darnassian Nightsaber |invehicle |q 13790 |goto 71.62,22.49 |only if NightElf
Mount the Stabled Gnomeregan Mechanostrider |invehicle |q 13790 |goto 71.93,22.50 |only if Gnome
|only if haveq(13790) or completedq(13790)
step
