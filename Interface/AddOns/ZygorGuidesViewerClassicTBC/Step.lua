...
function Step:CycleWaypoint(delta,nocycle,because)
	...
	local isValid = function(goal)  return goal and goal.x and not goal.force_noway and goal:IsVisible() and (not goal:IsCompleteable() or select(2,goal:IsComplete() --[[possible--]] ))  end
