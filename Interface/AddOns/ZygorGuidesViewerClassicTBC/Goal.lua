...
GOALTYPES['get'] = { -- combining old 'get' and 'collect' now.
	...
	iscomplete = function(self)
		...
		if self.targetid2 then got = got + C_Item.GetItemCount(self.targetid2) end
		if self.targetid3 then got = got + C_Item.GetItemCount(self.targetid3) end
...
GOALTYPES['gossip'] = {
	parse = function(self,params)
		_, self.gossipid = ParseID(params)
	end,
}
...
GOALTYPES['havebuff'] = {
	...
	gettext = function(self)
		if self.spellid and not self.qspellname then self.qspellname = GetSpellInfo(self.buff) end
