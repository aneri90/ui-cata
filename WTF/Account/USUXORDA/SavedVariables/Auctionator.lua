...
AUCTIONATOR_CONFIG = {
	...
	["selling_reselect_item_2"] = {
		["keyName"] = "k_Weapon",
		["sortKey"] = "55439_Mereldar Spellblade of the Wildfire_300_2_true",
	},
}
...
AUCTIONATOR_SHOPPING_LISTS = {
	{
		["items"] = {
			...
			"Rigid Cogwheel", -- [2]
			"Veiled Demonseye", -- [3]
			"Brilliant Inferno Ruby", -- [4]
			"Artful Ember Topaz", -- [5]
			"Fractured Cogwheel", -- [6]
			"Chaotic Shadowspirit Diamond", -- [7]
			"Brilliant Carnelian", -- [8]
			"Artful Hessonite", -- [9]
			"Veiled Nightstone", -- [10]
		},
		["name"] = "Gems",
		["isTemporary"] = false,
	}, -- [1]
...
AUCTIONATOR_RECENT_SEARCHES = {
	"Veiled Nightstone", -- [1]
	"Artful Hessonite", -- [2]
	"Brilliant Carnelian", -- [3]
	"Perfect Brilliant Carnelian", -- [4]
	"Inferno Ruby", -- [5]
	"Chaotic Shadowspirit Diamond", -- [6]
	"Fractured Cogwheel", -- [7]
	"Artful Ember Topaz", -- [8]
	"Brilliant Inferno Ruby", -- [9]
	"Veiled Demonseye", -- [10]
	"Rigid Cogwheel", -- [11]
	"Burning Shadowspirit Diamond", -- [12]
	"Flask of the Draconic Mind", -- [13]
	"Volcanic Potion", -- [14]
	"Seafood Magnifique Feast", -- [15]
	"Fortune Cookie", -- [16]
	"Severed Sagefish Head", -- [17]
	"Severed Sagefish Head,", -- [18]
	"Embersilk cloth", -- [19]
	"volatile air", -- [20]
	"volatile airs", -- [21]
	"volatile fire", -- [22]
